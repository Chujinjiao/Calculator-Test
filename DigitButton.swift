...
// DRAW THE SNAIL CIRCLE. The buttons will be put follow the snail circle
...
class DigitButton: UIButton {
    ...
    @IBInspectable var backColor: UIColor = UIColor.orangeColor()
...
//        arcPath.lineWidth = 3
        ...
        for i in 1...14 {
            ...
            print("\(i)radius and angle are : \(radius)  \(angle)")
